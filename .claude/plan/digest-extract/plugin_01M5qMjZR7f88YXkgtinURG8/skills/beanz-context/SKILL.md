...
name: beanz-context
description: >
  Background knowledge for the Beanz Daily Digest plugin. Use when generating
  digests, answering Beanz-related questions, or needing context about beanz.com
  metrics, team members, key projects, markets, deadlines, or glossary terms.
---

# Beanz Business Context

Background knowledge for the Beanz Daily Digest plugin. Draw on this automatically when generating digests or answering Beanz-related questions.
