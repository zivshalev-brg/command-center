...
const KNOWN_PROJECTS = [
  'FTBP', 'Platinum Roasters', 'Project Feral', 'PBB',
  'DE Launch', 'NL Launch', 'UK Market', 'US Expansion', 'AU Operations',
  ...
  'Customer Support', 'Content Marketing', 'Analytics Dashboard', 'Platinum US',
  'Shopify Integration', 'D365 Migration', 'Finance P&L', 'Pricing Strategy'
];
...
const SYSTEM_PROMPT = [
  ...
  '',
  'PROJECT MATCHING RULES (tag EVERY matching project — threads often relate to multiple):',
  ...
  '- Platinum US: Platinum US, US platinum, Ally Barajas, US roaster partner',
  '- Project Feral: feral, AI-first retention, cancellation flow, collections, onboarding email, 26-week',
  '- PBB: powered by beanz, B2B, partner, white-label, wholesale',
  '- DE Launch: Germany, Deutschland, DE market, Hamburg, Berlin, German',
  '- NL Launch: Netherlands, NL, Benelux, Amsterdam, Dutch, PostNL, Blommers, Dam Coffee, Rotterdam',
  '- UK Market: UK, United Kingdom, London, British, Sage, EMEA',
  '- US Expansion: US market, San Diego, Oakland, American, WOC, US roaster',
  '- AU Operations: Australia, AU market, Melbourne, Sydney, APAC (when not about events)',
  '- Affordability: pricing, discount, affordability, cost, margin, economics',
  '- Pricing Strategy: pricing model, price point, subscription tier, tier change',
  '- Oracle: Oracle ERP, NetSuite, order management, Oracle system',
  '- D365 Migration: D365, Dynamics 365, ERP migration, CommerceTools reconciliation',
  '- Shopify Integration: Shopify, e-commerce platform, storefront, checkout',
  '- MICE: MICE, Melbourne International Coffee Expo, AfterHours, booth',
  '- WOC: WOC, World of Coffee (when US-focused specifically)',
  '- Brand Summit: brand summit, FY27 summit, brand strategy presentation',
  '- Machine Integration: machine integration strategy, stakeholder alignment',
  '- MaraX3: MaraX3, Mara X3, LELIT, pressure profiles',
  '- Barista Touch Impress: Barista Touch, BTI, touch impress',
  '- Email Lifecycle: email campaign, lifecycle, retention email, welcome series, winback flow',
  '- Cancellation Flow: cancel flow, churn, retention, save offer, cancellation survey',
  '- Collections: collection page, product collection, merchandise, SKU curation',
  '- Onboarding: onboarding flow, welcome series, first-run, trial experience',
  '- Customer Support: ticket, complaint, support query, Zendesk, customer issue',
  '- Content Marketing: content calendar, blog, Instagram, social content, EDM content',
  '- Analytics Dashboard: dashboard, Power BI report, metric view, KPI visualisation',
  '- Finance P&L: P&L, profit and loss, revenue report, COGS, margin analysis',
  '',
